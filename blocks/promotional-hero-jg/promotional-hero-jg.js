...
function createDescription(cell, config = {}) {
  ...
  wrapper.className = 'promotional-hero-jg-description';
  ...
  if (config.descriptionMaxLines && config.descriptionMaxLines !== 'none') {
    wrapper.style.setProperty('--promotional-hero-jg-description-max-lines', config.descriptionMaxLines);
  }
...
function buildCard(row, index, config) {
  ...
  card.className = 'promotional-hero-jg-card';

  const imageData = extractImageSource(imageCell);
  if (imageData?.src) {
    const media = document.createElement('div');
    media.className = 'promotional-hero-jg-image';
  ...
  button.className = 'promotional-hero-jg-button';
...
export default function decorate(block) {
  // Promotional Hero V2: extract CTA color config rows before main decoration
  [...block.children].forEach((row) => {
    const cells = [...row.children];
    if (cells.length === 2) {
      const key = cells[0]?.textContent.trim().toLowerCase().replace(/\s+/g, '-');
      const value = cells[1]?.textContent.trim();
      if (key === 'cta-button-color' && value) {
        block.dataset.promoherojgBtnfill = value;
        block.dataset.promoherojgBtncolor = value;
        row.remove();
  ...
  warnOnInvalidConfig('promoherojg-align', raw.align, layoutConfig.align, DEFAULTS.align);
  warnOnInvalidConfig('promoherojg-columns', raw.columns, layoutConfig.columns, DEFAULTS.columns);
  warnOnInvalidConfig('promoherojg-cardwidth', raw.cardWidth, layoutConfig.cardWidth, DEFAULTS.cardWidth);
  warnOnInvalidConfig('promoherojg-cardheight', raw.cardHeight, layoutConfig.cardHeight, DEFAULTS.cardHeight);
  warnOnInvalidConfig('promoherojg-imageratio', raw.imageRatio, layoutConfig.imageRatio, DEFAULTS.imageRatio);
  warnOnInvalidConfig('promoherojg-imagefit', raw.imageFit, layoutConfig.imageFit, DEFAULTS.imageFit);
  warnOnInvalidConfig('promoherojg-gap', raw.gap, layoutConfig.gap, DEFAULTS.gap);
  warnOnInvalidConfig('promoherojg-density', raw.density, layoutConfig.density, DEFAULTS.density);
  warnOnInvalidConfig('promoherojg-contentstyle', raw.contentStyle, layoutConfig.contentStyle, DEFAULTS.contentStyle);
  warnOnInvalidConfig('promoherojg-contentalign', raw.contentAlign, layoutConfig.contentAlign, DEFAULTS.contentAlign);
  warnOnInvalidConfig('promoherojg-panelwidth', raw.panelWidth, layoutConfig.panelWidth, DEFAULTS.panelWidth);
  warnOnInvalidConfig('promoherojg-paneloffset', raw.panelOffset, layoutConfig.panelOffset, DEFAULTS.panelOffset);
  warnOnInvalidConfig('promoherojg-gridmaxwidth', raw.gridMaxWidth, layoutConfig.gridMaxWidth, DEFAULTS.gridMaxWidth);
  warnOnInvalidConfig('promoherojg-mobilelayout', raw.mobileLayout, layoutConfig.mobileLayout, DEFAULTS.mobileLayout);
  warnOnInvalidConfig('promoherojg-descmaxlines', raw.descriptionMaxLines, layoutConfig.descriptionMaxLines, DEFAULTS.descriptionMaxLines);
  warnOnInvalidConfig('promoherojg-descstyle', raw.descriptionStyle, layoutConfig.descriptionStyle, DEFAULTS.descriptionStyle);
  warnOnInvalidConfig('promoherojg-width', raw.width, layoutConfig.width, DEFAULTS.width);
  warnOnInvalidConfig('promoherojg-layout', raw.layout, layoutConfig.layout, DEFAULTS.layout);
  warnOnInvalidConfig('promoherojg-contentborderstyle', raw.contentBorderStyle, styleConfig.contentBorderStyle, DEFAULTS.contentBorderStyle);
  warnOnInvalidConfig('promoherojg-contentshadow', raw.contentShadow, styleConfig.contentShadow, DEFAULTS.contentShadow);
  warnOnInvalidConfig('promoherojg-contentradius', raw.contentRadius, styleConfig.contentRadius, DEFAULTS.contentRadius);
  warnOnInvalidConfig('promoherojg-cardborderstyle', raw.cardBorderStyle, styleConfig.cardBorderStyle, DEFAULTS.cardBorderStyle);
  warnOnInvalidConfig('promoherojg-cardborderwidth', raw.cardBorderWidth, styleConfig.cardBorderWidth, DEFAULTS.cardBorderWidth);
  warnOnInvalidConfig('promoherojg-btnstyle', raw.buttonStyle, styleConfig.buttonStyle, DEFAULTS.buttonStyle);
  warnOnInvalidConfig('promoherojg-btncorner', raw.buttonCorner, styleConfig.buttonCorner || '', DEFAULTS.buttonCorner);
  warnOnInvalidConfig('promoherojg-btnwidth', raw.buttonWidth, structureConfig.buttonWidth, DEFAULTS.buttonWidth);
  warnOnInvalidConfig('promoherojg-btncase', raw.buttonTextTransform, styleConfig.buttonTextTransform, DEFAULTS.buttonTextTransform);
  warnOnInvalidConfig('promoherojg-btnborder', raw.buttonBorderWidth, styleConfig.buttonBorderWidth, DEFAULTS.buttonBorderWidth);
  warnOnInvalidConfig('promoherojg-btnshadow', raw.buttonShadow, styleConfig.buttonShadow, DEFAULTS.buttonShadow);
  warnOnInvalidConfig('promoherojg-btnsize', raw.buttonFontSize, styleConfig.buttonFontSize, DEFAULTS.buttonFontSize);
  warnOnInvalidConfig('promoherojg-btnweight', raw.buttonFontWeight, styleConfig.buttonFontWeight, DEFAULTS.buttonFontWeight);
  warnOnInvalidConfig('promoherojg-cardradius', raw.cardRadius, styleConfig.cardRadius, DEFAULTS.cardRadius);
  warnOnInvalidConfig('promoherojg-imageshadow', raw.imageShadow, styleConfig.imageShadow, DEFAULTS.imageShadow);
  warnOnInvalidConfig('promoherojg-contentbg', raw.contentBgColor, colorConfig.contentBgColor, DEFAULTS.contentBgColor);
  warnOnInvalidConfig('promoherojg-contenttext', raw.contentTextColor, colorConfig.contentTextColor, DEFAULTS.contentTextColor);
  warnOnInvalidConfig('promoherojg-contentbordercolor', raw.contentBorderColor, colorConfig.contentBorderColor, DEFAULTS.contentBorderColor);
  warnOnInvalidConfig('promoherojg-cardbordercolor', raw.cardBorderColor, colorConfig.cardBorderColor, DEFAULTS.cardBorderColor);
  warnOnInvalidConfig('promoherojg-btncolor', raw.buttonBorderColor, colorConfig.buttonBorderColor, DEFAULTS.buttonBorderColor);
  warnOnInvalidConfig('promoherojg-btnfill', raw.buttonFillColor, colorConfig.buttonFillColor, DEFAULTS.buttonFillColor);
  warnOnInvalidConfig('promoherojg-btntext', raw.buttonTextColor, colorConfig.buttonTextColor, DEFAULTS.buttonTextColor);
  warnOnInvalidConfig('promoherojg-imageoverlaycolor', raw.imageOverlayColor, colorConfig.imageOverlayColor, DEFAULTS.imageOverlayColor);
  warnOnInvalidConfig('promoherojg-bgcolor', raw.backgroundColor, colorConfig.backgroundColor, DEFAULTS.backgroundColor);
  warnOnInvalidConfig('promoherojg-imageposition', raw.imagePosition, layoutConfig.imagePosition, DEFAULTS.imagePosition);
  warnOnInvalidConfig('promoherojg-hovereffect', raw.hoverEffect, motionConfig.hoverEffect, DEFAULTS.hoverEffect);
  warnOnInvalidConfig('promoherojg-imageoverlay', raw.imageOverlay, motionConfig.imageOverlay, DEFAULTS.imageOverlay);
  warnOnInvalidConfig('promoherojg-btnhovermotion', raw.buttonHoverMotion, motionConfig.buttonHoverMotion, DEFAULTS.buttonHoverMotion);
  warnOnInvalidConfig('promoherojg-btnhovercolor', raw.buttonHoverColor, motionConfig.buttonHoverColor, DEFAULTS.buttonHoverColor);

  if (styleConfig.buttonStyle === 'link') {
    if (hasExplicitConfig.buttonCorner) {
      warnOnNoOpConfig(
        'promoherojg-btncorner',
        raw.buttonCorner,
  ...
  const applyResponsiveLayout = () => {
    ...
    block.style.setProperty('--promotional-hero-jg-linear-max-cols', `${linearColumnCount}`);
    block.style.setProperty('--promotional-hero-jg-layout-scale', layoutScale);
  };
  ...
  block.style.setProperty('--promotional-hero-jg-button-bg', buttonFillColorToken);
  block.style.setProperty('--promotional-hero-jg-button-border', buttonBorderColorToken);
  block.style.setProperty('--promotional-hero-jg-button-text', buttonTextColorToken);
  block.style.setProperty('--promotional-hero-jg-button-hover-bg', buttonHoverBgColorToken);
  block.style.setProperty('--promotional-hero-jg-button-hover-border', buttonHoverBorderColorToken);
  block.style.setProperty('--promotional-hero-jg-button-hover-text', buttonTextColorToken);
  block.style.setProperty('--promotional-hero-jg-content-bg', contentBgColorToken);
  block.style.setProperty('--promotional-hero-jg-content-color', contentTextColorToken);
  block.style.setProperty('--promotional-hero-jg-content-border-color', contentBorderColorToken);
  block.style.setProperty('--promotional-hero-jg-card-border-color', cardBorderColorToken);
  block.style.setProperty('--promotional-hero-jg-image-overlay-color', imageOverlayColorToken);
  block.style.setProperty('--promotional-hero-jg-card-border-width', `${styleConfig.cardBorderWidth}px`);
  block.style.setProperty('--promotional-hero-jg-button-border-width', `${styleConfig.buttonBorderWidth}px`);
  block.style.setProperty('--promotional-hero-jg-button-font-weight', styleConfig.buttonFontWeight);
  block.style.setProperty('--promotional-hero-jg-background', backgroundColorToken);
  applyResponsiveLayout();

  const container = document.createElement('div');
  container.className = 'promotional-hero-jg-container';
